...
const Equip = ({ match }) => {
  ...
  }, [keyword, currentPage, price,alert, ratings,error]);
        ...
        <Fragment>
          <div className="mt-[69px] md:mt-10">
            ...
            <div className="flex md:mt-5">
              ...
              <div className="flex overflow-scroll ml-4 scrollbar-hide  space-x-5 md:flex-wrap md:justify-center md:space-x-5">
                {product &&
                  product.map((product) => (
