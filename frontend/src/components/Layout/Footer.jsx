...
<footer class="p-4 bg-black">
    <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
            <a href="/" class="flex items-center">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">Fit Check</span>
            </a>
        </div>
            ...
            <div>
                ...
                <ul class="text-white">
                    <li class="mb-4">
                        ...
                        <Link to= "/"> <div class="hover:underline">Fit Check</div></Link>
                    </li>
                    <li>
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-white sm:text-center">© 2022 <a href="/" class="hover:underline">Fit Check™</a>. All Rights Reserved.
        </span>
